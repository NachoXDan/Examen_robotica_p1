...
static const _Filtered_type_support_symbol_names_t _Filtered_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ucb_interface, msg, Filtered)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ucb_interface, msg, Filtered)),
  }
};
...
{
  return &::ucb_interface::msg::rosidl_typesupport_cpp::Filtered_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ucb_interface, msg, Filtered)() {
  return get_message_type_support_handle<ucb_interface::msg::Filtered>();
}
